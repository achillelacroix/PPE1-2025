...
On arrive maintenant au coeur du programme, une boucle while qui lit les lignes de l'argument fourni par l'utilisateurice. On dirait que le script attend une url donc il n'attend à priori qu'une ligne. Il affiche cette ligne puis à l'aide d'une expression régulière il évalue si cette ligne
